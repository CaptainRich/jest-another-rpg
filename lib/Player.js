...
class Player extends Character {
    constructor(name = '') {
        ...
        // Call the parent constructor, to make sure the parent (Character in this case) is 
        // properly initialized, before this class starts assigning properties.
        super(name);

        // These properties moved to the 'Character' class.
        // this.name = name;
    ...
    usePotion(index) {
        ...
        // as a new array.  Then the Potion at index 0 of this new array
        // is saved in the 'potion' variable.
        const potion = this.getInventory().splice(index, 1)[0];

        // Increase the appropriate feature.
        switch (potion.name) {
            case 'agility':
                this.agility += potion.value;
                console.log( "Agility potion adding: ", potion.value );
                break;
            case 'health':
                this.health += potion.value;
                console.log( "Health potion adding: ", potion.value );
                break;
            case 'strength':
                this.strength += potion.value;
                console.log( "Strength potion adding: ", potion.value );
                break;
        }
    };
